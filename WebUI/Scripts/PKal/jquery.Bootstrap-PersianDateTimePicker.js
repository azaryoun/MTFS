    ...
    function createDateTimePickerHtml($popoverDescriber, dateTimeInJsonFormat, writeDateString) {
        ...
        if (writeDateString) {
            if (fromDateToDateJson != undefined) {
                ...
                $target.val(getDateTimeString(dateTimeInJsonFormat, enableTimePicker)).trigger('input');;
        }

        $popoverDescriber.attr(mdSelectedDateTimeAttributeName, JSON.stringify(dateTimeInJsonFormat)).trigger('input');;
