...
var varnegotiationplanrouteController = function ($scope, $http, mainFactory, $httpParamSerializerJQLike, $rootScope, $window) {
    ...
    if ($rootScope.isUp == 1 && $rootScope.back_LevelSecond != 0) {
        $scope.parentId = $rootScope.back_LevelSecond;
    }
    ...
    $scope.getRecords = function () {
        ...
        $http({
            url: _ServicePath + '/Negotiationplanroute/getNegotiationplanroutesManagement',
            method: "GET",
            ...
            params: {
                ...
                .then(
                    function (response) {
                        ...
                        $scope.records = response.data.getNegotiationplanroutesDto;
    ...
    $scope.newRecord = function () {
        ...
        $scope.modalTitle = "Create Negotiation Plan Route"

        $("div#myLoadingModal").modal({ backdrop: false, keyboard: false, });
        $("body").css("padding-right", "0px");

        $http({
            url: _ServicePath + '/Negotiationplanroute/getNegotiationplanrouteInitial',
            method: "GET",
            headers: { 'Content-Type': 'application/x-www-form-urlencoded', 'Authorization': JWT_Token },
            params: {
                "parentId": $scope.parentId,
    ...
    $scope.editRecord = function (record) {
        ...
        $scope.modalTitle = "Edit Negotiation Plan Route"
        ...
        $http({
            url: _ServicePath + '/Negotiationplanroute/getNegotiationplanroute',
            method: "GET",
            headers: { 'Content-Type': 'application/x-www-form-urlencoded', 'Authorization': JWT_Token },
            params: { "id": record.id },
        })
    ...
    $scope.insertRecord = function () {
        ...
        $http({
            url: _ServicePath + '/Negotiationplanroute/insertNegotiationplanroute',
            method: "POST",
            headers: { 'Content-Type': 'application/x-www-form-urlencoded', 'Authorization': JWT_Token },
    ...
    $scope.updateRecord = function () {
        ...
        $http({
            url: _ServicePath + '/Negotiationplanroute/updateNegotiationplanroute',
            method: "PUT",
            headers: { 'Content-Type': 'application/x-www-form-urlencoded', 'Authorization': JWT_Token },
            data: $httpParamSerializerJQLike($scope.record),
        })
    ...
    $scope.subAction1 = function (id, title,parent_ParentId) {
        ...
        $rootScope.back_LevelSecond = parent_ParentId;
        $window.location.href = "#/menus/" + "SalesMarketing/NegotiationplanrouteCF/negotiationplanrouteCF".replace(/\//g, " ");

    }
}
;

varMainApplication.controller("negotiationplanrouteController", varnegotiationplanrouteController);
