...
var varnegotiationplanrouteCFController = function ($scope, $http, mainFactory, $httpParamSerializerJQLike, $rootScope, $window) {
    ...
    $scope.getRecords = function () {
        ...
        $http({
            url: _ServicePath + '/NegotiationplanrouteCF/getNegotiationplanrouteCFsManagement',
            method: "GET",
            ...
            params: {
                ...
                .then(
                    function (response) {
                        ...
                        $scope.records = response.data.getNegotiationplanrouteCFsDto;
    ...
    $scope.newRecord = function () {
        ...
        $scope.modalTitle = "Create Negotiation Plan RouteCF"

        $("div#myLoadingModal").modal({ backdrop: false, keyboard: false, });
        $("body").css("padding-right", "0px");

        $http({
            url: _ServicePath + '/NegotiationplanrouteCF/getNegotiationplanrouteCFInitial',
            method: "GET",
            headers: { 'Content-Type': 'application/x-www-form-urlencoded', 'Authorization': JWT_Token },
            params: {
                "parentId": $scope.parentId,
    ...
    $scope.editRecord = function (record) {
        ...
        $scope.modalTitle = "Edit Negotiation Plan RouteCF"
        ...
        $http({
            url: _ServicePath + '/NegotiationplanrouteCF/getNegotiationplanrouteCF',
            method: "GET",
            headers: { 'Content-Type': 'application/x-www-form-urlencoded', 'Authorization': JWT_Token },
            params: { "id": record.id },
        })
    ...
    $scope.insertRecord = function () {
        ...
        $("div#myLoadingModal").modal({ backdrop: false, keyboard: false, });
        $("body").css("padding-right", "0px");
        if ( ($scope.record.carrierId == null && $scope.record.forwarderId == null) ||
             ($scope.record.carrierId != null && $scope.record.forwarderId != null))
        {
            $('div#myLoadingModal').modal('toggle');
        ...
        $http({
            url: _ServicePath + '/NegotiationplanrouteCF/insertNegotiationplanrouteCF',
            method: "POST",
            headers: { 'Content-Type': 'application/x-www-form-urlencoded', 'Authorization': JWT_Token },
    ...
    $scope.updateRecord = function () {
        ...
        $http({
            url: _ServicePath + '/NegotiationplanrouteCF/updateNegotiationplanrouteCF',
            method: "PUT",
            headers: { 'Content-Type': 'application/x-www-form-urlencoded', 'Authorization': JWT_Token },
            data: $httpParamSerializerJQLike($scope.record),
        })
...
varMainApplication.controller("negotiationplanrouteCFController", varnegotiationplanrouteCFController);
