...
var varpackagetypeController = function ($scope, $http, mainFactory, $httpParamSerializerJQLike) {
     
    //Check Access to the Page
    var menuitemID = 6; //Page ID in DataBase
    ...
    $scope.getRecords = function () {
        ...
        $http({
            url: _ServicePath + '/Packagetype/getPackagetypesManagement',
            method: "GET",
            ...
            params: {
                ...
                .then(
                    function (response) {
                        ...
                        $scope.records = response.data.getPackagetypesDto;
    ...
    $scope.newRecord = function () {
        ...
        $scope.modalTitle = "Create Package Type"

        $("div#myLoadingModal").modal({ backdrop: false, keyboard: false, });
        $("body").css("padding-right", "0px");

        $http({
            url: _ServicePath + '/Packagetype/getPackagetypeInitial',
            method: "GET",
            headers: { 'Content-Type': 'application/x-www-form-urlencoded', 'Authorization': JWT_Token },
        })
                .then(
    ...
    $scope.editRecord = function (record) {
        ...
        $scope.modalTitle = "Edit Package Type"
        ...
        $http({
            url: _ServicePath + '/Packagetype/getPackagetype',
            method: "GET",
            headers: { 'Content-Type': 'application/x-www-form-urlencoded', 'Authorization': JWT_Token },
            params: { "id": record.id },
        })
    ...
    $scope.insertRecord = function () {
        ...
        $("div#myLoadingModal").modal({ backdrop: false, keyboard: false, });
        $("body").css("padding-right", "0px");
        $scope.record.countries = null;

        $http({
            url: _ServicePath + '/Packagetype/insertPackagetype',
            method: "POST",
            headers: { 'Content-Type': 'application/x-www-form-urlencoded', 'Authorization': JWT_Token },
    ...
    $scope.updateRecord = function () {
        ...
        $http({
            url: _ServicePath + '/Packagetype/updatePackagetype',
            method: "PUT",
            headers: { 'Content-Type': 'application/x-www-form-urlencoded', 'Authorization': JWT_Token },
            data: $httpParamSerializerJQLike($scope.record),
        })
    ...
    $scope.deleteRecord = function () {
        ...
        $.SmartMessageBox({
            ...
            $http({
                url: _ServicePath + '/Packagetype/deletePackagetype',
                method: "Delete",
                headers: { 'Content-Type': 'application/x-www-form-urlencoded', 'Authorization': JWT_Token },
...
varMainApplication.controller("packagetypeController", varpackagetypeController);
