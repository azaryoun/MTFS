...
var varcustomerController = function ($scope, $http, mainFactory, $httpParamSerializerJQLike) {


    //Check Access to the Page
    var menuitemID =9 //Page ID in DataBase
    ...
    $scope.getRecords = function () {
        ...
        $http({
            url: _ServicePath + '/Customer/getCustomersManagement',
            method: "GET",
            ...
            params: {
                ...
                .then(
                    function (response) {
                        ...
                        $scope.records = response.data.getCustomersDto;
    ...
    $scope.newRecord = function () {
        ...
        $http({
            url: _ServicePath + '/Customer/getCustomerInitial',
            method: "GET",
            headers: { 'Content-Type': 'application/x-www-form-urlencoded', 'Authorization': JWT_Token },
        })
                .then(
    ...
    $scope.editRecord = function (record) {
        ...
        $http({
            url: _ServicePath + '/Customer/getCustomer',
            method: "GET",
            headers: { 'Content-Type': 'application/x-www-form-urlencoded', 'Authorization': JWT_Token },
            params: { "id": record.id },
        })
    ...
    $scope.insertRecord = function () {
        ...
        $http({
            url: _ServicePath + '/Customer/insertCustomer',
            method: "POST",
            headers: { 'Content-Type': 'application/x-www-form-urlencoded', 'Authorization': JWT_Token },
    ...
    $scope.updateRecord = function () {
        ...
        $http({
            url: _ServicePath + '/Customer/updateCustomer',
            method: "PUT",
            headers: { 'Content-Type': 'application/x-www-form-urlencoded', 'Authorization': JWT_Token },
            data: $httpParamSerializerJQLike($scope.record),
        })
    ...
    $scope.deleteRecord = function () {
        ...
        $.SmartMessageBox({
            ...
            $http({
                url: _ServicePath + '/Customer/deleteCustomer',
                method: "Delete",
                headers: { 'Content-Type': 'application/x-www-form-urlencoded', 'Authorization': JWT_Token },
...
varMainApplication.controller("customerController", varcustomerController);
