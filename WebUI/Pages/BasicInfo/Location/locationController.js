...
var varlocationController = function ($scope, $http, mainFactory, $httpParamSerializerJQLike) {


    //Check Access to the Page
    var menuitemID = 5; //Page ID in DataBase
    ...
    $scope.getRecords = function () {
        ...
        $http({
            url: _ServicePath + '/Location/getLocationsManagement',
            method: "GET",
            ...
            params: {
                ...
                .then(
                    function (response) {
                        ...
                        $scope.records = response.data.getLocationsDto;
    ...
    $scope.newRecord = function () {
        ...
        $scope.modalTitle = "Create Location"

        $("div#myLoadingModal").modal({ backdrop: false, keyboard: false, });
        $("body").css("padding-right", "0px");

        $http({
            url: _ServicePath + '/Location/getLocationInitial',
            method: "GET",
            headers: { 'Content-Type': 'application/x-www-form-urlencoded', 'Authorization': JWT_Token },
        })
                .then(
    ...
    $scope.editRecord = function (record) {
        ...
        $scope.modalTitle = "Edit Location"
        ...
        $http({
            url: _ServicePath + '/Location/getLocation',
            method: "GET",
            headers: { 'Content-Type': 'application/x-www-form-urlencoded', 'Authorization': JWT_Token },
            params: { "id": record.id },
        })
    ...
    $scope.insertRecord = function () {
        ...
        $http({
            url: _ServicePath + '/Location/insertLocation',
            method: "POST",
            headers: { 'Content-Type': 'application/x-www-form-urlencoded', 'Authorization': JWT_Token },
    ...
    $scope.updateRecord = function () {
        ...
        $http({
            url: _ServicePath + '/Location/updateLocation',
            method: "PUT",
            headers: { 'Content-Type': 'application/x-www-form-urlencoded', 'Authorization': JWT_Token },
            data: $httpParamSerializerJQLike($scope.record),
        })
    ...
    $scope.deleteRecord = function () {
        ...
        $.SmartMessageBox({
            ...
            $http({
                url: _ServicePath + '/Location/deleteLocation',
                method: "Delete",
                headers: { 'Content-Type': 'application/x-www-form-urlencoded', 'Authorization': JWT_Token },
...
varMainApplication.controller("locationController", varlocationController);
