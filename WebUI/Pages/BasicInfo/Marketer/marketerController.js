...
var varmarketerController = function ($scope, $http, mainFactory, $httpParamSerializerJQLike) {


    //Check Access to the Page
    var menuitemID =7; //Page ID in DataBase
    ...
    $scope.getRecords = function () {
        ...
        $http({
            url: _ServicePath + '/Marketer/getMarketersManagement',
            method: "GET",
            ...
            params: {
                ...
                .then(
                    function (response) {
                        ...
                        $scope.records = response.data.getMarketersDto;
    ...
    $scope.newRecord = function () {
        ...
        $scope.modalTitle = "Create Marketer"

        $("div#myLoadingModal").modal({ backdrop: false, keyboard: false, });
        $("body").css("padding-right", "0px");

        $http({
            url: _ServicePath + '/Marketer/getMarketerInitial',
            method: "GET",
            headers: { 'Content-Type': 'application/x-www-form-urlencoded', 'Authorization': JWT_Token },
        })
                .then(
    ...
    $scope.editRecord = function (record) {
        ...
        $scope.modalTitle = "Edit Marketer"
        ...
        $http({
            url: _ServicePath + '/Marketer/getMarketer',
            method: "GET",
            headers: { 'Content-Type': 'application/x-www-form-urlencoded', 'Authorization': JWT_Token },
            params: { "id": record.id },
        })
    ...
    $scope.insertRecord = function () {
        ...
        $http({
            url: _ServicePath + '/Marketer/insertMarketer',
            method: "POST",
            headers: { 'Content-Type': 'application/x-www-form-urlencoded', 'Authorization': JWT_Token },
    ...
    $scope.updateRecord = function () {
        ...
        $http({
            url: _ServicePath + '/Marketer/updateMarketer',
            method: "PUT",
            headers: { 'Content-Type': 'application/x-www-form-urlencoded', 'Authorization': JWT_Token },
            data: $httpParamSerializerJQLike($scope.record),
        })
    ...
    $scope.deleteRecord = function () {
        ...
        $.SmartMessageBox({
            ...
            $http({
                url: _ServicePath + '/Marketer/deleteMarketer',
                method: "Delete",
                headers: { 'Content-Type': 'application/x-www-form-urlencoded', 'Authorization': JWT_Token },
...
varMainApplication.controller("marketerController", varmarketerController);
