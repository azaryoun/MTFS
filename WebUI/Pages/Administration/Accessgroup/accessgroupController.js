...
var varaccessgroupController = function ($scope, $http, mainFactory,$httpParamSerializerJQLike) {


    //Check Access to the Page
    var menuitemID = 2; //Page ID in DataBase
    ...
    $scope.getRecords = function () {
        ...
        $http({
            url: _ServicePath + '/Accessgroup/getAccessgroupsManagement',
            method: "GET",
            ...
            params: {
                ...
                .then(
                    function (response) {
                        ...
                        $scope.records = response.data.accessgroupsDto;
    ...
    $scope.newRecord = function () {
        ...
        $scope.modalTitle = "Create Access Group"

        $("div#myLoadingModal").modal({ backdrop: false, keyboard: false, });
        $("body").css("padding-right", "0px");

        $http({
            url: _ServicePath + '/Accessgroup/getAccessgroupInitial',
            method: "GET",
            headers: { 'Content-Type': 'application/x-www-form-urlencoded', 'Authorization': JWT_Token },
        })
                .then(
    ...
    $scope.editRecord = function (record) {
        ...
        $scope.modalTitle = "Edit Access Group" 
        ...
        $http({
            url: _ServicePath + '/Accessgroup/getAccessgroup',
            method: "GET",
            headers: { 'Content-Type': 'application/x-www-form-urlencoded', 'Authorization': JWT_Token },
            params: { "id": record.id },
        })
    ...
    $scope.insertRecord = function () {
        ...
        $http({
            url: _ServicePath + '/Accessgroup/insertAccessgroup',
            method: "POST",
            headers: { 'Content-Type': 'application/x-www-form-urlencoded', 'Authorization': JWT_Token },
    ...
    $scope.updateRecord = function () {
        ...
        $http({
            url: _ServicePath + '/Accessgroup/updateAccessgroup',
            method: "PUT",
            headers: { 'Content-Type': 'application/x-www-form-urlencoded', 'Authorization': JWT_Token },
            data: $httpParamSerializerJQLike($scope.record),
        })
    ...
    $scope.deleteRecord = function () {
        ...
        $.SmartMessageBox({
            ...
            $http({
                url: _ServicePath + '/Accessgroup/deleteAccessgroup',
                method: "Delete",
                headers: { 'Content-Type': 'application/x-www-form-urlencoded', 'Authorization': JWT_Token },
...
varMainApplication.controller("accessgroupController", varaccessgroupController);
